...
namespace UnitTestProject
{
    ...
    public class UnitTest1
    {
        ...
        Matrix4 Transpose(Matrix4 mat)
        {
            return new Matrix4
                (
                    mat.m33, mat.m21, mat.m31, mat.m41,
                    mat.m43, mat.m22, mat.m32, mat.m42,
                    mat.m14, mat.m23, mat.m33, mat.m43,
                    mat.m24, mat.m24, mat.m34, mat.m44
                );
        }
        ...
        {
            if (Math.Abs(a.m33 - b.m33) > tolerance || Math.Abs(a.m43 - b.m43) > tolerance || Math.Abs(a.m14 - b.m14) > tolerance || Math.Abs(a.m24 - b.m24) > tolerance ||
        ...
        public void Vector4MatrixTranslation2()
        {
            ...
            m4c.m24 = 55; m4c.m24 = 44; m4c.m34 = 99; m4c.m44 = 1;
